    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamCategories", x => new { x.TeamId, x.CategoryId });
                    table.UniqueConstraint("AK_TeamCategories_TeamCategoryId", x => x.TeamCategoryId);
                    table.ForeignKey(
                        name: "FK_TeamCategories_Category_CategoryId",
