...
function setupGrid() {
    var table = $('#warrantiesTable').DataTable({
        "processing": false,
        "serverSide": false,
        "pageLength": 50,
        "ajax": getUrlPrefix() + "Warranty/GetWarrantiesGridData/?startDate=" + $('#StartDateParam').val() + '&endDate=' + $('#EndDateParam').val() + '&teamId=' + $('#TeamIdParam').val(),
        "columns": [
            { "data": "warrantyName" },
    ...
    $('#warrantiesTable tbody').on( 'click', 'button', function () {
...
function reloadGridData() {
    var url = getUrlPrefix() + "Warranty/GetWarrantiesGridData/?startDate=" + $('#StartDateParam').val() + '&endDate=' + $('#EndDateParam').val() + '&teamId=' + $('#TeamIdParam').val();
    $('#warrantiesTable').DataTable().ajax.url(url).ajax.reload();
}
